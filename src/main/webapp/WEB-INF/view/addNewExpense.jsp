        ...
        <div class="col-sm-12 col-md-8 col-lg-6 mx-auto">
            <div class="card card-body bg-dark mt-5 mx-auto">
                <div class="card-title text-center text-white">
                    <h3 class="text-capitalize">add new expense</h3>
                </div>
                <form:form modelAttribute="expense" method="post">
                    ...
                    <div class="input-group mt-3 w-50 mx-auto">
                        <input type="submit" class="btn btn-success pt-1 px-4" value="Add">
                    </div>
...
<c:choose>
    ...
    <c:otherwise>
        <input id="currentDate" type="hidden" value="${defaultDate}"></input>
        <script>
            var date = document.getElementById("currentDate").value;
            $(function () {
                $("#datepicker").datepicker().val(date);
            });
        </script>
    </c:otherwise>
</c:choose>
